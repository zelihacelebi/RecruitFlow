...
namespace RecruitFlow.Application.Services
{
    public class JobPositionService : IJobPositionService   
    {
        ...
        public async Task<IEnumerable<JobPositionDto>> GetAllAsync(PaginationRequest paginationRequest)
        {
            var jobPositions = await _jobPositionRepository.GetAllAsync(paginationRequest);
        ...
        public async Task<JobPositionDto> UpdateAsync(Guid id, UpdateJobPositionDto dto)
        {
            var jobPosition = await _jobPositionRepository.GetByIdAsync(id);
